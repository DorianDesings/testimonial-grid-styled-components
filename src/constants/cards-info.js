...
export const CARDS_INFO = [
	{
		...
		$borderImage: COLORS.purpleBorder,
		$mainTextColor: COLORS.textLight,
		$secondaryTextColor: COLORS.textGrey,
		$gridColumn: '1/3',
		$gridRow: '1/2'
	},
	{
